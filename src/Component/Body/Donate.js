                    ...
                    <div className="mt-5 ">
                      <div className="mt-3 text-[#111]">
                        <h2 className="text-[22px] leading-7 font-normal">
                          Radical James Talarico Raised Nearly $11 Million in
                          ONE Month. We Need YOUR Help Right Now...
                        </h2>

                        <p className="mt-6 text-[15px]">
                          One month. $10,791,775!
                        </p>

                        <p className="mt-8 text-[15px] leading-5">
                          That is what James Talarico raised online in May
                          alone. He has now raised over $50 million for this
                          race, leads in some recent polls, and he JUST launched
                          statewide television ads in ALL major TV markets.
                        </p>

                        <p className="mt-8 text-[15px] leading-5">
                          Millions of undecided voters will hear his version of
                          this race. His framing. His $11 million. Unless Ken
                          has the resources to answer back.
                        </p>

                        <p className="mt-8 text-[15px] leading-5">
                          Those same voters do not know James Talarico called
                          the American flag a complicated symbol. They do not
                          know he secretly flew to San Francisco for billionaire
                          fundraisers while telling Texans he was fighting
                          billionaire influence. They do not know he said God is
                          nonbinary or that he wants a welcome mat at the
                          southern border.
                        </p>

                        <p className="mt-8 text-[15px] leading-5">
                          They are about to find out from Talarico's ads. Unless
                          we act today.
                        </p>

                        <p className="mt-8 text-[15px] leading-5">
                          Ken Paxton fights for us. He took on the Biden
                          administration more than 100 times and won. He is
                          ready for this next fight. But he cannot close a $50
                          million gap without you.
                        </p>
          ...
          selectedButton === amount
            ...
            : "bg-[#08386f] hover:bg-[#0b4d96]"
                            ...
                            <p className="text-center text-[13px] mt-4 text-gray-700">
                              Your contribution will benefit Ken Paxton for
                              Senate.
                            </p>
                            ...
                            >
                              <label className="flex gap-3 items-start cursor-pointer">
                                ...
                                >
                                  ...
                                  nearly{" "}
                                  <span className="font-bold">$70 million</span>{" "}
                                  to beat Ken Paxton and turn Texas Blue. All
                                  that stands in the way of this happening is{" "}
                                  <span className="font-bold">YOU.</span> Will
                                  you step up one more time by checking this box
                                  and making an additional one time contribution
                                  on <span className="font-bold">July 31</span>?
                                  We are relying on your support to help fight
                                  back against the Democrats and their
                                  billionaire supporters. Please check this box
                                  and make one more gift for this critical goal.
                                  <span
                            ...
                            <>
                              ...
                              <div className="mt-4 text-[10px] leading-4 text-[#666]">
                                <label className="flex items-start gap-2">
                                  <span>
                                    Sign up for text updates! By participating,
                                    you agree to the
                                    ...
                                    for recurring autodialed campaign and
                                    donation messages from Ken Paxton to the
                                    phone number you provide. No consent
                                    required to buy. Text STOP to end. Msg&data
                                    rates may apply.
                                  </span>
                                </label>
                              </div>
                ...
                <div className="p-5">
                  ...
                  <div className="mt-5 ">
                    <div className="mt-3 text-[#111]">
                      ...
                      <p className="mt-8 text-[15px] leading-5">
                        That is what James Talarico raised online in May alone.
                        He has now raised over $50 million for this race, leads
                        in some recent polls, and he JUST launched statewide
                        television ads in ALL major TV markets.
                      </p>

                      <p className="mt-8 text-[15px] leading-5">
                        Millions of undecided voters will hear his version of
                        this race. His framing. His $11 million. Unless Ken has
                        the resources to answer back.
                      </p>

                      <p className="mt-8 text-[15px] leading-5">
                        Those same voters do not know James Talarico called the
                        American flag a complicated symbol. They do not know he
                        secretly flew to San Francisco for billionaire
                        fundraisers while telling Texans he was fighting
                        billionaire influence. They do not know he said God is
                        nonbinary or that he wants a welcome mat at the southern
                        border.
                      </p>
                      ...
                      <p className="mt-8 text-[15px] leading-5">
                        ...
                        for this next fight. But he cannot close a $50 million
                        gap without you.
                      </p>
                          ...
                          >
                            <label className="flex gap-3 items-start cursor-pointer">
                              ...
                              >
                                ...
                                nearly{" "}
                                <span className="font-bold">$70 million</span>{" "}
                                to beat Ken Paxton and turn Texas Blue. All that
                                ...
                                <span className="font-bold">July 31</span>? We
                                are relying on your support to help fight back
                                against the Democrats and their billionaire
                                supporters. Please check this box and make one
                                more gift for this critical goal.
                                <span
                                  className={`block text-center font-bold text-[15px] ${
                                    extraDonation
                                      ? "text-white"
                            ...
                            <div className="mt-4 text-[10px] leading-4 text-[#666]">
                              <label className="flex items-start gap-2">
                                <span>
                                  ...
                                  messages from Ken Paxton to the phone number
                                  you provide. No consent required to buy. Text
                                  STOP to end. Msg&data rates may apply.
                                </span>
                              </label>
                            </div>
                          ...
                          <>
                            ...
                            <div className="flex border border-[#d9d9d9] overflow-hidden rounded-sm">
                              ...
                              <input
                                ...
                                className="w-[70px] text-center text-[14px] text-[#0f2d5e] font-bold   outline-none border-r placeholder:font-bold placeholder:text-[#8b8b8b]"
                              />
                              ...
                              <input
                                ...
                                readOnly
                                className="w-[70px] text-center text-[14px] text-[#0f2d5e] font-bold outline-none placeholder:font-bold placeholder:text-[#8b8b8b]"
                              />
                            </div>
      ...
      <section className="relative bg-white z-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 md:px-12 py-8 md:py-12">
          <div className="max-w-[700px] mx-auto px-0 md:px-8 py-6 md:py-10 text-[14px] md:text-[15px] leading-6 text-[#333]">
            <p className="mb-5">
              By participating, you agree to the terms recurring autodialed
              marketing messages from Ken Paxton to the phone number you
              provide. No consent required to buy. Msg&amp;data rates may apply.
            </p>
